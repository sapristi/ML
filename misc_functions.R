...
misc_funs$df.make.empty <- function(nrow, colnames=c(), stringsAsFactors=TRUE) {
...
#'
misc_funs$multiplot <- function(..., plotlist=NULL, file, cols=1, layout=NULL) {
    library(grid)
...
misc_funs$multiplot2 <- function(..., plotlist=NULL, file, cols=1) {
  library(grid)
